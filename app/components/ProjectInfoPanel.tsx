...
const InfoSections = ({ project }: { project: Project }) => (
  <>
    {(project.year || project.status) && (
      <div className="flex gap-8 mb-6 last:mb-0">
        {project.year && (
          <div>
...
const MobilePanel = ({ project }: { project: Project }) => {
...
const DesktopPanel = ({ project, className }: { project: Project; className?: string }) => (
  <div
    className={cx(
...
export default function ProjectInfoPanel({ project, variant = "desktop", className }: ProjectInfoPanelProps) {
  if (variant === "mobile") {
    return <MobilePanel project={project} />;
  }
  return <DesktopPanel project={project} className={className} />;
}
