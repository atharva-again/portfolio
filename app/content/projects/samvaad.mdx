...
<Image src={samvaad1} alt="An image showing a screenshot of welcome to samvaad screen from the Samvaad CLI." />
---
<Image src={samvaad2} alt="An image showing a screenshot of Samvaad CLI in use." />
---
<Image src={samvaad3} alt="An image showing a screenshot of Samvaad CLI with a voice conversation." />